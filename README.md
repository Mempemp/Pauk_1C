...
> ⚠️ Развитие проекта на данный момент находится на стопе, [ai_rules_1c](https://github.com/comol/ai_rules_1c) в репозитории от comol вышло большое обновление(27.04.2026), которое вроде как закрывает основную идею данного репозитория - прогрессивное подмешивание контекста через диспетчирезацию/маршрутизацию. Продолжу если пойму, что данное решение "из коробки" мне не подходит 
