...
Применяй при работе с **запросами к базе** (объект `Запрос`), **виртуальными таблицами** регистров, **выборками для обработки**, **отчётами и списками**, **массовой обработке** таблиц данных из запроса.
