...
3. **Детали по темам** (читать выборочно):
...
4. **[checklist-precommit.md](checklist-precommit.md)** — чеклист перед фиксацией.
...
| 19 | Один серверный вызов вместо нескольких | Задержки КС | directives-forms-cs |
